...
import { CheckCircle, ArrowRight, Zap, Globe, TrendingUp, Mail } from "lucide-react";
  ...
  const benefits = [
    {
      ...
      description: "Dominate search results, social media, and email marketing"
    },
    {
      icon: TrendingUp,
      title: "Maximum Growth",
      description: "Comprehensive strategies for traffic and lead generation"
    },
    {
      icon: Mail,
      title: "Multi-Channel Marketing",
      description: "Reach customers wherever they are online"
    },
    {
      icon: Zap,
      title: "Priority Service",
      description: "Get the fastest response times and best support"
    }
  ];
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-accent/20 rounded-full px-4 py-1 mb-6">
              ...
              <span className="text-sm font-medium text-accent">Most Popular Package</span>
            </div>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12">Everything You Need to Dominate Online</h2>
            
            <div className="grid md:grid-cols-2 gap-8">
              <Card>
                <CardContent className="p-8">
                  <h3 className="text-2xl font-bold mb-6">Complete Marketing Package</h3>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-background rounded-lg p-6">
                ...
                <div className="text-sm text-muted-foreground">ROI on Marketing</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-gradient-to-r from-primary to-accent text-white">
        <div className="container mx-auto px-6">
          <AuditCTA 
            ...
            subtitle="Get your free digital marketing audit and see how to outperform your competitors"
